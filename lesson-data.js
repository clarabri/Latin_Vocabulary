...
const defaultLessonData = {
  ...
  { la:"idem...qui", de:["derselbe ... wie", "dergleiche ... wie"], wt:"Pronomen", badge:"wt-pron", stf:"—", hint:"Identität ausdrücken", icon:"repeat" },
  { la:"umquam", de:["jemals"], wt:"Adverb", badge:"wt-adv", stf:"—", hint:"vergleiche: numquam", icon:"clock" },
  { la:"convertere", de:["verändern","verwandeln", "(um)wandeln"], wt:"Verb", badge:"wt-v", stf:"converto, converti, conversum", hint:"con + vertere", icon:"refresh-cw" },
