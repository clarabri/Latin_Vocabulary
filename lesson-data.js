...
const defaultLessonData = {
  ...
  { la:"puer novem annorum", de:["ein neunjähriger Junger"], wt:"Nomen", badge:"wt-n", stf:"—", hint:"Hannibals Alter", icon:"child" },
  ...
  { la:"repetere", de:["wiederholen","zurückerlangen"], wt:"Verb", badge:"wt-v", stf:"repeto, repetivi, repetitum", hint:"re + petere", icon:"rotate-cw" },
  { la:"odium", de:["Hass"], wt:"Nomen", badge:"wt-n", stf:"odii, n.", hint:"Gefühl der Verachtung", icon:"angry" },
  { la:"idem...qui", de:["derselbe...wie"], wt:"Pronomen", badge:"wt-pron", stf:"—", hint:"Identität ausdrücken", icon:"repeat" },
  { la:"umquam", de:["jemals"], wt:"Adverb", badge:"wt-adv", stf:"—", hint:"vergleiche: numquam", icon:"clock" },
  { la:"convertere", de:["verändern","verwandeln"], wt:"Verb", badge:"wt-v", stf:"converti, conversum", hint:"con + vertere", icon:"refresh-cw" },
  { la:"Carthaginiensis", de:["karthagisch","Karthager"], wt:"Adjektiv/Nomen", badge:"wt-a", stf:"—", hint:"Aus Karthago", icon:"flag" },
